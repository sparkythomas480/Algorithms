...
public class SelectionSortTests
{
    ...
    {
        var exception = Assert.Throws<ArgumentNullException>(() => SelectionSort.DoAscending<double>(null!));
    ...
    public void DoAscending_Works_Correctly_When_Zero_Elements()
    {
        ...
        SelectionSort.DoAscending(toSort);
        Assert.Empty(toSort);
    }
    ...
    {
        var exception = Assert.Throws<ArgumentNullException>(() => SelectionSort.DoDescending<int>(null!));
        Assert.Equal("elements", exception.ParamName);
        Assert.Equal("The elements argument must not be null. (Parameter 'elements')", exception.Message);
    }
    ...
    {
        var toSort = new List<int>();
        SelectionSort.DoDescending(toSort);
        Assert.Empty(toSort);
    }
